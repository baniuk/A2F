...
class ATL_NO_VTABLE CPort :
	...
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_CCF1Lib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
//	CUnitOperation unit;
	STDMETHOD(get_mydirection)(BYTE* pVal);
	STDMETHOD(put_mydirection)(BYTE newVal);
	...
	~CPort(void);
	STDMETHOD(put_unit)(CapeValidationStatus* newVal);
