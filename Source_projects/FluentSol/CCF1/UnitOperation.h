...
public:
	...
	STDMETHOD(Calculate)()
	{
		...
		if(T.vt==(VT_ARRAY|VT_R8) && p.vt==(VT_ARRAY|VT_R8) && X.vt==(VT_ARRAY|VT_R8) && f.vt==(VT_ARRAY|VT_R8))	{
			...
			runfluent->GetParams(temperature,fraction,flow,pressure);	// odzysk parametrów (czêœæ mo¿e byæ wejœciowych czêœæ z fluenta)
...
public:
	...
	// get - zwraca z komponentu i wystawia do wskaŸnika, str 195
public:
