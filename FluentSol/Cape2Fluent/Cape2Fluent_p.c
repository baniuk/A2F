...
typedef struct _Cape2Fluent_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Cape2Fluent_MIDL_TYPE_FORMAT_STRING;

typedef struct _Cape2Fluent_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Cape2Fluent_MIDL_PROC_FORMAT_STRING;

typedef struct _Cape2Fluent_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
...
extern const Cape2Fluent_MIDL_TYPE_FORMAT_STRING Cape2Fluent__MIDL_TypeFormatString;
extern const Cape2Fluent_MIDL_PROC_FORMAT_STRING Cape2Fluent__MIDL_ProcFormatString;
extern const Cape2Fluent_MIDL_EXPR_FORMAT_STRING Cape2Fluent__MIDL_ExprFormatString;
...
static const Cape2Fluent_MIDL_PROC_FORMAT_STRING Cape2Fluent__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 304 */	NdrFcShort( 0x430 ),	/* Type Offset=1072 */
...
/* 412 */	NdrFcShort( 0x442 ),	/* Type Offset=1090 */
...
static const Cape2Fluent_MIDL_TYPE_FORMAT_STRING Cape2Fluent__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1098 */	NdrFcShort( 0xfe00 ),	/* Offset= -512 (586) */
/* 1100 */	
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    Cape2Fluent__MIDL_ProcFormatString.Format,
...
/* Object interface: IUnitOperation, ver. 0.0,
   GUID={0x439937D7,0xDF7A,0x4A90,{0x97,0x2E,0x77,0x98,0x24,0xDC,0x8C,0x76}} */
...
/* Object interface: IPort, ver. 0.0,
   GUID={0x7369F1D6,0xFC5C,0x4671,{0x83,0x2D,0xE2,0xB0,0xE5,0x95,0xC7,0x07}} */
...
CINTERFACE_PROXY_VTABLE(16) _IPortProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IPort::get_direction */ ,
    (void *) (INT_PTR) -1 /* IPort::put_direction */ ,
...
/* Object interface: IParameterCollection, ver. 0.0,
   GUID={0x4B96ACBB,0xFF51,0x4DE7,{0xB2,0x1A,0xE3,0x68,0x44,0x6C,0x89,0x7D}} */
...
/* Object interface: IPortCollection, ver. 0.0,
   GUID={0x711072EC,0x6409,0x44EF,{0x87,0x5A,0x11,0xA9,0x88,0xC0,0xB2,0x5C}} */
...
PCInterfaceName const _Cape2Fluent_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
...
#define _Cape2Fluent_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Cape2Fluent, pIID, n)

int __stdcall _Cape2Fluent_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Cape2Fluent, 5, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _Cape2Fluent, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _Cape2Fluent, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Cape2Fluent, 5, *pIndex )
    
}

const ExtendedProxyFileInfo Cape2Fluent_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Cape2Fluent_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Cape2Fluent_StubVtblList,
    (const PCInterfaceName * ) & _Cape2Fluent_InterfaceNamesList,
    (const IID ** ) & _Cape2Fluent_BaseIIDList,
    & _Cape2Fluent_IID_Lookup, 
    5,
    2,
