========================================================================
    ACTIVE TEMPLATE LIBRARY : CCF1 Project Overview
========================================================================

AppWizard has created this CCF1 project for you to use as the starting point for
...
CCF1.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CCF1.h)
        GUID definitions                                (CCF1_i.c)
        A type library                                  (CCF1.tlb)
        Marshaling code                                 (CCF1_p.c and dlldata.c)

CCF1.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CCF1.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CCF1.pch and a precompiled types file named StdAfx.obj.
...
CCF1ps.vcproj
	...
	dlldata.c, CCF1_i.c and CCF1_p.c which are required
